# Coinbase Pro Ruby library - Updated fork

This is a fork of the Coinbase Pro Ruby Library.  The official library is no longer supported or maintained, but this one is.
